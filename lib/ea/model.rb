...
module Ea
  ...
  module Model
    ...
    autoload :Constraint, "ea/model/constraint"
    autoload :Slot, "ea/model/slot"
    autoload :InstanceSpecification, "ea/model/instance_specification"
    ...
    autoload :Note, "ea/model/note"
    autoload :Legend, "ea/model/legend"
    autoload :LegendItem, "ea/model/legend_item"
    autoload :GhostLabel, "ea/model/ghost_label"
    ...
    autoload :Signal, "ea/model/signal"
