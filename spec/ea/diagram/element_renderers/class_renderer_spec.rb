...
RSpec.describe Ea::Diagram::ElementRenderers::ClassRenderer do
  ...
  describe "#render_shape" do
    ...
    it "renders rectangle for class box", :aggregate_failures do
      shape = renderer.render_shape(style)
  ...
  describe "private methods" do
    describe "#calculate_attributes_height" do
      it "returns 0 when no attributes" do
        height = renderer.calculate_attributes_height()
    ...
    describe "#calculate_operations_height" do
      it "returns 0 when no operations" do
        height = renderer.calculate_operations_height()
    ...
    describe "#format_attribute" do
      it "formats attribute with visibility, name, and type" do
        ...
        result = renderer.format_attribute(attr)
      ...
      it "handles plain string attribute" do
        result = renderer.format_attribute("name")
    ...
    describe "#format_operation" do
      it "formats operation with visibility, name, parameters, " \
        ...
        result = renderer.format_operation(op)
      ...
      it "handles plain string operation" do
        result = renderer.format_operation("method()")
    ...
    describe "#format_parameters" do
      it "formats array of parameter hashes" do
        ...
        result = renderer.format_parameters(params)
      ...
      it "handles empty parameters" do
        result = renderer.format_parameters([])
    ...
    describe "#visibility_symbol" do
      it "returns + for public" do
        symbol = renderer.visibility_symbol("public")

        expect(symbol).to eq("+")
      end

      it "returns - for private" do
        symbol = renderer.visibility_symbol("private")

        expect(symbol).to eq("-")
      end

      it "returns # for protected" do
        symbol = renderer.visibility_symbol("protected")

        expect(symbol).to eq("#")
      end

      it "returns ~ for package" do
        symbol = renderer.visibility_symbol("package")

        expect(symbol).to eq("~")
      end

      it "returns empty string for unknown visibility" do
        symbol = renderer.visibility_symbol("unknown")

        expect(symbol).to eq("")
      end

      it "returns empty string for nil visibility" do
        symbol = renderer.visibility_symbol(nil)
    ...
    describe "#render_text_element" do
      ...
      it "renders SVG text element", :aggregate_failures do
        text = renderer.render_text_element("Test", 100, 50, style,
                             "test-class")
      ...
      it "escapes text content" do
        text = renderer.render_text_element("<tag>", 100, 50, style,
                             "test-class")
      ...
      it "returns empty string for nil text" do
        text = renderer.render_text_element(nil, 100, 50, style,
                             "test-class")
      ...
      it "accepts custom options" do
        text = renderer.render_text_element(
