...
RSpec.describe Ea::Transformations::Parsers::XmiParser do
  ...
  describe "#parse" do
    ...
    context "with non-XMI XML content" do
      ...
      it "attempts to parse but failed and return error" do
        ...
        end.to raise_error(Ea::Transformations::Parsers::ParseError)
      end
    end
  ...
  describe "configuration integration" do
    ...
    it "uses transformation options from configuration" do
      configuration.transformation_options = Ea::Transformations::Configuration::TransformationOptions.new
  ...
  describe "error handling" do
    let(:large_xmi_path) do
      File.join(
        __dir__,
        "../../../../../lutaml-uml/examples/xmi/20251010_current_plateau_v5.1.xmi",
      )
    end
