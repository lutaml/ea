...
RSpec.describe Ea::Transformations::Parsers::BaseParser do
    ...
    context "with parsing failure" do
      ...
      it "raises parsing error" do
        expect do
          ...
          Ea::Transformations::Parsers::ParseError, /Parsing failed/
        )
      end
  ...
  describe "abstract method enforcement" do
    ...
    it "raises NotImplementedError for parse_internal" do
      ...
      begin
        expect do
          abstract_parser.parse_internal(test_file.path)
        end.to raise_error(NotImplementedError)
      ensure
        test_file.unlink
      end
  ...
  describe "default implementations" do
    ...
    it "provides default validate_file!" do
      ...
      begin
        expect do
          parser.validate_file!(test_file.path)
    ...
    it "provides default validate_output!" do
      ...
      expect do
        parser.validate_output!(mock_result)
      end.not_to raise_error
    end
  end
  ...
  describe "configuration integration" do
    ...
    it "respects error handling configuration" do
      configuration.error_handling =
        Ea::Transformations::Configuration::ErrorHandling.new
