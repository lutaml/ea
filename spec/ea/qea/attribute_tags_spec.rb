...
RSpec.describe "Attribute Tags Support" do
  ...
  describe Ea::Qea::Models::EaAttributeTag do
  ...
  describe Ea::Qea::Factory::AttributeTagTransformer do
    ...
    describe "#transform" do
      it "transforms EA attribute tag to UML TaggedValue",
        ...
        ea_tag = Ea::Qea::Models::EaAttributeTag.new(
          property_id: 1,
          element_id: 367,
          property: "isMetadata",
          value: "false",
  ...
  describe "Attribute Tags Integration" do
    ...
    it "loads attribute tags with correct structure", :aggregate_failures do
      ...
      expect(tag).to be_a(Ea::Qea::Models::EaAttributeTag)
    ...
    it "attaches attribute tags to UML attributes as tagged values" do
      ...
      aggregate_failures do
        ...
        # Transform to UML
        attr_transformer = Ea::Qea::Factory::AttributeTransformer.new(database)
