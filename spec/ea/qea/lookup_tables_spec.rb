...
RSpec.describe "Priority 3 Lookup Tables" do
  ...
  describe "Constraint Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(constraint_type).to be_a(Ea::Qea::Models::EaConstraintType)
  ...
  describe "Connector Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(connector_type).to be_a(Ea::Qea::Models::EaConnectorType)
  ...
  describe "Diagram Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(diagram_type).to be_a(Ea::Qea::Models::EaDiagramType)
  ...
  describe "Object Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(object_type).to be_a(Ea::Qea::Models::EaObjectType)
  ...
  describe "Status Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(status_type).to be_a(Ea::Qea::Models::EaStatusType)
  ...
  describe "Complexity Types" do
    ...
    it "has correct structure" do
      ...
      aggregate_failures do
        expect(complexity_type).to be_a(Ea::Qea::Models::EaComplexityType)
