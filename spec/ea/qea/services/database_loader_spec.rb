...
RSpec.describe Ea::Qea::Services::DatabaseLoader do
  ...
  describe "#initialize" do
    ...
    it "loads default configuration" do
      expect(loader.config).to be_a(Ea::Qea::Services::Configuration)
    end

    it "accepts custom configuration" do
      config = Ea::Qea::Services::Configuration.new
  ...
  describe "#on_progress" do
    it "sets progress callback" do
      ...
      expect(loader).to respond_to(:on_progress)
    end
  ...
  describe "MODEL_CLASSES constant" do
    it "maps all table names to model classes" do
      expect(described_class::MODEL_CLASSES).to include(
        "t_object" => Ea::Qea::Models::EaObject,
        "t_attribute" => Ea::Qea::Models::EaAttribute,
        "t_operation" => Ea::Qea::Models::EaOperation,
        "t_operationparams" => Ea::Qea::Models::EaOperationParam,
        "t_connector" => Ea::Qea::Models::EaConnector,
        "t_package" => Ea::Qea::Models::EaPackage,
        "t_diagram" => Ea::Qea::Models::EaDiagram,
      )
    end
  end
  ...
  context "with temporary test database" do
    ...
    describe "#load_table" do
      ...
      it "returns model instances" do
        objects = test_loader.load_table("t_object")
        expect(objects.first).to be_a(Ea::Qea::Models::EaObject)
      end
    ...
    describe "#quick_stats" do
      ...
      it "does not load actual records" do
        ...
        expect(Ea::Qea::Models::EaObject).not_to receive(:from_db_row)
