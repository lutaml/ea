...
RSpec.describe "Object Properties Support" do
  ...
  describe Ea::Qea::Models::EaObjectProperty do
  ...
  describe Ea::Qea::Factory::ObjectPropertyTransformer do
    ...
    describe "#transform" do
      it "transforms EA object property to UML TaggedValue",
        ...
        ea_prop = Ea::Qea::Models::EaObjectProperty.new(
          property_id: 1,
          object_id: 684,
          property: "isCollection",
          value: "false",
  ...
  describe "Object Properties Integration" do
    ...
    it "loads object properties with correct structure", :aggregate_failures do
      ...
      expect(property).to be_a(Ea::Qea::Models::EaObjectProperty)
    ...
    it "attaches object properties to UML classes as tagged values" do
      ...
      aggregate_failures do
        ...
        class_transformer = Ea::Qea::Factory::ClassTransformer.new(database)
